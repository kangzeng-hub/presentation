...
def main(argv: list[str] | None = None) -> int:
    ...
    command.add_argument("--competitor-analysis", default="docs/competitor-visual-analysis.md")
    command.add_argument("--registry", default="templates/registry.json")
    command.add_argument("--output", default="image_plan.json")
    command.add_argument("--resolved-output", default="resolved_templates.json")
